...
class TeamsAndRepositoriesConnector @Inject()(
  ...
  def allServices(implicit hc: HeaderCarrier): Future[Seq[RepositoryDisplayDetails]] =
    http.GET[Seq[RepositoryDisplayDetails]](teamsAndServicesBaseUrl + s"/api/services")
